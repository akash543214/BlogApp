    ...
    <div>
      ...
      <div className="mx-auto max-w-7xl px-2">
        <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
          ...
          Welcome to CodeX, your space for tech talk! Join developers sharing insights, triumphs, 
          and challenges. Let's code, connect, and collaborate! 🖥️ #DevHub #CodeTalks
          </p>
        ...
        <div className="grid gap-6 gap-y-10 py-6 md:grid-cols-2 lg:grid-cols-3">
          {posts.map((post) => (
            ...
            <div key={post.id} className="border">
              <img src={appwriteService.getFilePreview(post.featuredImage)} className="aspect-video w-full rounded-md" alt="" />
              <div className="min-h-min p-3">
                ...
                <p className="mt-4 w-full text-sm leading-normal text-gray-600">
                  This is an example Description about the post content.
                </p>
